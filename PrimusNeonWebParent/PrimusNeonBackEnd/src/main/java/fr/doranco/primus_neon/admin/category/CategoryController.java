...
public class CategoryController {
	...
	public String newCategory(Model model) {
		...
		model.addAttribute("listCategories", listCategories);
		model.addAttribute("pageTitle", "Créer une nouvelle categorie");
	...
	public String saveCategory(Category category, @RequestParam(name = "fileImage") MultipartFile multipartFile,
		...
		ra.addFlashAttribute("message", "La catégorie a été enregistré avec succès.");
	...
	public String editCategory(@PathVariable("id") Integer id, Model model, RedirectAttributes ra) {
		...
		try {
			...
			model.addAttribute("listCategories", listCategories);
			model.addAttribute("pageTitle", "Modifier la categorie (ID : " + id + ")");
	...
	public String updateCategoryEnabledStatus(@PathVariable("id") Integer id, @PathVariable("status") boolean enabled,
		...
		String message = "L'ID categorie " + id + " a été " + status;
	 ...
	 public String deleteCategory(@PathVariable("id") Integer id, Model model,
	  ...
	  "L'ID categorie " + id + " a été supprimé avec succès.");

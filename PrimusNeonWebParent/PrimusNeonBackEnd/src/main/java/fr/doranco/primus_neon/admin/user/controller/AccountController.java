...
public class AccountController {
	...
	@GetMapping("/account")
	public String viewDetails(@AuthenticationPrincipal PrimusNeonUserDetails loggedUser, Model model) {
	...
	public String saveDetails(User user, RedirectAttributes redirectAttributes,
			@AuthenticationPrincipal PrimusNeonUserDetails loggedUser,
		...
		redirectAttributes.addFlashAttribute("message", "Vos détails de compte ont été mises à jour.");

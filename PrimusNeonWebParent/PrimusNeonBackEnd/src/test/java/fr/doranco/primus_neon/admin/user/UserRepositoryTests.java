...
/*
	...
	public void testCreateNewUserWithOneRole() {
		...
		User userArabeHid = new User("Arabe", "Hidouche", "hkass@hotmail.fr", "Kss693300!");
	...
	public void testCreateNewUserWithTwoRoles() {
		...
		User userKassi = new User("Kassi", "Hidouche", "hkass21@gmail.com", "93300Kss6!");
	...
	public void testDisableUser() {
		...
		Integer id = 2;
		repo.updateEnabledSatatus(id, false);
	...
	public void testEnableUser() {
		...
		Integer id = 2;
		repo.updateEnabledSatatus(id, true);
